...
export default function Home() {
  ...
  useEffect(() => {
    // Only check for hash after loading is complete
    if (loading) return;
    ...
    // Also check after short delays (for slower connections)
  ...
  return (
    <main className="bg-gray-50">
      {/* Hero with Sanity banner support */}
      <Hero banner={heroBanner} />
     
      {/* Stats section */}
      <Stats />
     
      {/* Services section with dynamic data */}
      <Services services={services} />
     
      {/* Portfolio section */}
      <Portfolio />
     
      {/* CTA with Sanity banner support */}

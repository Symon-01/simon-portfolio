// FILE LOCATION: src/app/simon-arts/SimonArtsPageClient.tsx
"use client";
...
export default function SimonArtsPageClient() {
  ...
  if (loading) {
    return (
      <section className="py-6 lg:py-8 bg-white min-h-screen">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center">
            <p className="text-gray-600 card-desc">Loading artworks...</p>
          </div>
        </div>
      </section>
    );
                ...
                >
                  <div className="bg-gray-50 rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col">
                    ...
                    {artwork.mainImage && (
                      <div className="relative w-full overflow-hidden bg-white" style={{ aspectRatio: '1 / 1.414' }}>
                        ...
                        <div className="absolute top-3 left-3 flex flex-col gap-2">
                          {artwork.featured && (
                            <span 
                              className="text-white px-2.5 py-1 rounded-full font-bold text-xs"
                    ...
                    <div className="p-4 lg:p-5 flex-grow flex flex-col">
                      <div 
                        className="card-desc font-semibold mb-2 uppercase tracking-wide"
                        style={{color: '#EF6203'}}
                      >
                      ...
                      <div className="pt-3 border-t border-gray-200 mt-auto">
                        <span 
                          className="link-text inline-flex items-center font-semibold group-hover:translate-x-1 transition-transform"
                          style={{color: '#048F02'}}
                        >
                          View Details
                          <svg 

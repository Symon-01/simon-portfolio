...
// ── Issue masthead — desktop UNCHANGED from Image 2, mobile condensed ─────────
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-4">
        ...
        <div className="flex items-center justify-between text-xs text-gray-400 pb-3 border-b border-gray-100 flex-wrap gap-2">
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <span className="hidden sm:inline">{formatDate(issue.publishedDate)}</span>
            <span className="sm:hidden">
              {new Date(issue.publishedDate).toLocaleDateString('en-KE', {
        ...
        {/* Title — clamp keeps it proportional on all screens */}
        <div className="flex items-center justify-center pb-3" style={{ gap: '0.75rem' }}>
          <div className="flex flex-col h-12 w-1 rounded-sm overflow-hidden flex-shrink-0">
            <div className="flex-1" style={{ background: '#006600' }} />
            <div className="flex-1" style={{ background: '#BB0000' }} />
            <div className="flex-1" style={{ background: '#000000' }} />
          </div>
          <h1
            ...
            style={{
              ...
              // Desktop stays exactly as Image 2 (3xl–5xl range)
              // Mobile scales down gracefully with clamp
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-8 lg:px-12 pb-16">
          ...
          {/*
           * DESKTOP: two columns — (viewer + reviews) | (info panel + share)  ← Image 2 layout preserved
           * MOBILE:  single column — info panel → viewer → share → reviews
           */}
          <div className="grid lg:grid-cols-[1fr_300px] gap-8 items-start">

            {/* ── Left column ── */}
            <div>
              {/* Info panel — mobile only (shown above viewer) */}

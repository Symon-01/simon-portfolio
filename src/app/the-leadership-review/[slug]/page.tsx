    ...
    <div className="w-full">
      ...
      <div className="flex items-center justify-between px-4 py-3 rounded-t-xl" style={{ background: '#283583' }}>
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="text-white font-bold text-sm truncate" style={{ fontFamily: "'Playfair Display', serif" }}>
            {title}
          </span>
        </div>
        <button
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 lg:px-12 py-4">
        ...
        <div className="flex items-center justify-center pb-3" style={{ gap: '0.75rem' }}>
          ...
          <h1 className="font-black leading-none select-none text-center"
            style={{ fontFamily: "'Playfair Display', serif", fontSize: 'clamp(22px, 5.5vw, 52px)' }}>

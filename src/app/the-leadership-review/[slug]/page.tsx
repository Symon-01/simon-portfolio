  ...
  return (
    <div className="rounded-xl overflow-hidden" style={{ border: '1.5px solid #283583' }}>
      ...
      <div className="bg-white p-4">
        <div className="flex items-center justify-center gap-2 flex-nowrap overflow-x-auto pb-1">
          {[
            ...
            <button key={label} onClick={action} title={label}
              ...
              style={{ background: bg }}>{icon}</button>
          ))}
          <button onClick={handleCopyLink} title="Copy link"
            className="flex-shrink-0 bg-gray-600 hover:bg-gray-700 text-white p-2 rounded-lg transition-colors">
            {copied
        ...
        <div className="mt-4 pt-4 border-t border-gray-100"><SupportButton position="top" /></div>
      </div>
    </div>
  );
}
        ...
        <div className="space-y-3">
          {reviews.map((r, i) => (
            <div key={i} className="bg-white rounded-xl p-4 transition-all duration-700"
              ...
              <p className="text-sm text-gray-700 italic leading-relaxed my-2" style={{ fontFamily: "'Georgia', serif" }}>
  ...
  return (
    <div className="overflow-hidden" style={{ border: '1.5px solid #283583', borderRadius: '16px', boxShadow: '0 8px 32px rgba(40,53,131,0.13)' }}>
      <div className="px-4 py-3 flex items-center gap-2" style={{ background: '#283583' }}>
        <div className="flex flex-col h-6 w-1 rounded-sm overflow-hidden flex-shrink-0">
          <div className="flex-1" style={{ background: '#006600' }} /><div className="flex-1" style={{ background: '#BB0000' }} /><div className="flex-1" style={{ background: '#000000' }} />
        </div>

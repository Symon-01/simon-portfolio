...
function ReaderReviews({ reviews, issueTitle, issueSlug }: {
  ...
  return (
    <div className="mt-8">
      <h2 className="text-lg font-black text-center py-3 tracking-wide"
...
function IssueInfoPanel({ issue, showDownload, onDownload, downloading, hideCover = false }: {
  ...
  return (
    <div className="overflow-hidden"
      style={{ border: '1.5px solid #283583', borderRadius: '16px', boxShadow: '0 8px 32px rgba(40,53,131,0.13), 0 2px 8px rgba(0,0,0,0.07)' }}>
      ...
      {!hideCover && issue.coverImage?.asset?.url && (
        <div className="relative overflow-hidden" style={{ height: '220px' }}>
          ...
          <div className="absolute bottom-0 left-0 right-0 h-16"
            style={{ background: 'linear-gradient(to top, rgba(40,53,131,0.85), transparent)' }} />
          <span className="absolute bottom-3 left-3 text-white text-xs font-black px-2.5 py-1 rounded"
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center px-6">
          <h1 className="text-2xl font-black text-gray-900 mb-3" style={{ fontFamily: "'Playfair Display', serif" }}>
            Issue Not Found
          </h1>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-8 lg:px-12 pb-16 pt-6">
          ...
          <div className="hidden lg:grid lg:grid-cols-[1fr_300px] gap-8 items-start">
            ...
            <div className="flex flex-col gap-4 sticky top-6">
              <IssueInfoPanel issue={issue} showDownload={true} onDownload={handleDownload}
                downloading={downloading} hideCover={false} />
          ...
          <div className="mt-6 text-center">
            <Link href="/the-leadership-review"
              className="inline-flex items-center text-sm font-bold gap-2 transition-opacity hover:opacity-70"
              style={{ color: '#283583' }}>
              ← View All Issues
            </Link>
          </div>
